...
>O medo de um **ataque soviético** motivou os EUA a criarem a *ARPA (hoje DARPA)*, uma agência para **desenvolver tecnologias de defesa e comunicação**.
...
**O protocolo inicial, NCP,** era ineficiente à medida que a rede crescia. Outras redes surgiam (via satélite), **cada uma com suas próprias linguagens**, criando uma '*Torre de Babel*' digital.
...
- A linguagem para criar e estruturar páginas web: ***HTML (HyperText Markup Language)***
- O protocolo para acessar as páginas de um servidor: ***HTTP (HyperText Transfer Protocol)***
- O sistema de endereçamento único para encontrar qualquer recurso na web: ***URL (Uniform Resource Locator)***

Ele decidiu não cobrar patentes por isso, *permitindo que qualquer pessoa criasse sites livremente*. Em 1993, essas tecnologias **foram disponibilizadas ao domínio público**.
